...
type ServiceTypeRow = {
  ...
  assignments?: { services?: { id: string; name: string | null; active: boolean | null } | { id: string; name: string | null; active: boolean | null }[] | null }[] | null;
};
  ...
  const loadData = async () => {
    ...
    const normalizedServices =
      (servicesResponse.data ?? []).map((entry: ServiceTypeRow) => ({
        ...
        branch_name: entry.branch?.name ?? null,
