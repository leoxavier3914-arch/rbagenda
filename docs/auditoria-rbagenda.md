...
- Responsividade: sidebar fixa/fechada no desktop (ícones sempre visíveis) e drawer no mobile (menu escondido até abrir, backdrop para fechar). As grades quebram para 1 coluna em telas estreitas, tabela possui scroll horizontal e os cards/tickets mantêm margens/gaps semelhantes ao template de referência.
