...
type ThemePreferencesPanelProps = {
  ...
  cardTopHexRef: RefObject<HTMLInputElement>
  cardBottomHexRef: RefObject<HTMLInputElement>
  cardBorderHexRef: RefObject<HTMLInputElement>
  bgTopHexRef: RefObject<HTMLInputElement>
  bgBottomHexRef: RefObject<HTMLInputElement>
  glassBorderHexRef: RefObject<HTMLInputElement>
  glassHexRef: RefObject<HTMLInputElement>
  bubbleDarkHexRef: RefObject<HTMLInputElement>
  bubbleLightHexRef: RefObject<HTMLInputElement>
}
