    ...
    <div className="relative isolate">
      ...
      <div className="relative mx-auto w-full max-w-6xl px-4 py-10 sm:px-8 sm:py-14">
        <section className="overflow-hidden rounded-[32px] border border-white/70 bg-white/85 shadow-2xl backdrop-blur">
          <div className="grid gap-8 bg-gradient-to-br from-emerald-900/80 via-emerald-800/70 to-emerald-700/70 p-8 text-white sm:grid-cols-[1.2fr_1fr] sm:p-10">
            <div className="space-y-3">
              <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-emerald-50 ring-1 ring-white/20">
                Regras atualizadas
              </span>
              <h1 className="text-3xl font-semibold sm:text-4xl">Experiência alinhada do agendamento ao pós-procedimento</h1>
              <p className="text-sm text-emerald-50/90 sm:text-base">
                Organizamos políticas claras para manter a agenda fluindo, preservar seu horário favorito e garantir um atendimento seguro. Revise quando precisar e conte com a equipe para orientar cada etapa.
              </p>
          ...
          <div className="space-y-10 p-6 sm:p-10">
                ...
                <header className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-[color:rgba(31,45,40,0.75)]">
                      Revise a linha do tempo do seu atendimento para saber quando confirmar, ajustar ou cancelar.
                    </p>
                  </div>
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-[color:rgba(31,45,40,0.78)]">
                      Seguimos as mesmas cores e clima das páginas de perfil, agendamentos e procedimentos para manter consistência.
                    </p>
                  </div>
            ...
            <section className="grid gap-6 lg:grid-cols-3">
              {policyBlocks.map((block) => (
                <article
                  key={block.title}
                  className="relative overflow-hidden rounded-3xl border border-emerald-100/80 bg-white/90 p-6 shadow-lg ring-1 ring-black/5"
                >
            ...
            <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
              <article className="rounded-3xl border border-emerald-100/80 bg-white/90 p-6 shadow-lg ring-1 ring-black/5">
                <header className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                  <div className="space-y-1">
              ...
              <article className="flex flex-col justify-between gap-4 rounded-3xl border border-emerald-100/80 bg-gradient-to-br from-emerald-900/80 via-emerald-800/80 to-emerald-700/80 p-6 text-white shadow-xl ring-1 ring-black/10">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-emerald-50/85">
                    Alinhamos linguagem e cores com Meu Perfil, Agendamentos e Procedimentos para que você reconheça rapidamente o ambiente da plataforma.
                  </p>
                </div>
                <div className="space-y-3">
